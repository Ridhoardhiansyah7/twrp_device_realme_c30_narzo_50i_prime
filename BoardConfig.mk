...
DEVICE_PATH := device/realme/RMX3506
...
# Assert
TARGET_OTA_ASSERT_DEVICE := RMX3506, rmx3506, RMX3581, rmx3581
...
TARGET_KERNEL_CONFIG := RMX3506_defconfig
TARGET_KERNEL_SOURCE := kernel/realme/RMX3506
...
# A.29 firmware patch
PLATFORM_SECURITY_PATCH := 2023-01-11
VENDOR_SECURITY_PATCH := 2023-01-11
...
include device/realme/RMX3506/partitions.mk

# Recovery flags
include device/realme/RMX3506/recovery_flags.mk
